...
# @File          : i3
# @Description   : Installer script for i3
# @TODO          :
# @Other         :
# @Resource      :
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# end with a space
APP="$APPNAME xfce4-terminal xfce4-power-manager volumeicon xscreensaver "
APP+="conky tint2 xbindkeys firefox notify-send iwconfig catfish dmenu lxappearance qt5ct "
PERL=""
PYTH=""
PIPS=""
CPAN=""
